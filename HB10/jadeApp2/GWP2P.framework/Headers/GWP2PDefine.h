...
/**
 ...
 @param dataDictionary        返回数据,与设备通信成功后返回所请求的数据,不成功会返回失败原因，具体指令是否成功会保存在此字典的GWP2PMessageResult键对应的 NSNumber包装的BOOL值：成功，可以取具体数据或操作设备成功；失败，GWP2PMessageDescription键对应的值中会描述具体原因
 */
...
static NSString *const GWP2PMessageResult = @"result";/**< 结果 对应BOOL类型 */
...
typedef NS_ENUM(NSUInteger, P2PClientMessageError) {
    ...
    P2PClientMessageErrorMessageIsSending,  /**< 当前请求正在进行 */
    P2PClientMessageErrorParameterError,    /**< 传递参数错误 */
    P2PClientMessageErrorUnKnow = 9999      /**< 未知错误 */
};
...
typedef NS_ENUM(NSUInteger, GWSensorAlarmType) {
    ...
    GWSensorAlarmTypeSmoke,                 /**< 40smoke */
    GWSensorAlarmTypeGas = 41,              /**< 41gas */
    GWSensorAlarmTypeDoorMagnet,            /**< 42door magnet */
    GWSensorAlarmTypeTemprature,            /**< 43 temprature */
    GWSensorAlarmTypeHumidity,              /**< 44 humidity */
    GWSensorAlarmTypePIRAlarm,              /**< 45pir */
